        ...
        <>
            ...
            <div className='controler_timer'>
                ...
                <div style = {{position: 'absolute', top: '125px', left: '290px', textAlign: 'center'}}>
                    ...
                    <Button variant="outline-dark" size = 'sm' style = {{fontSize : '8px'}} onClick={timer_resetShow}>초기화</Button><br/>
                    <Modal show={timer_reset_show} onHide={timer_resetClose} animation={false}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button variant="primary" onClick = {() => {timer_control('playtime','reset')}}>
                                초기화 
                            </Button>
                        </Modal.Footer>
                    </Modal>
                ...
                {timer_calculate()}
                <div style = {{position: 'absolute', top: '125px', left: '350px', textAlign: 'center'}}>
                    <Button variant="outline-dark" size = 'sm' style = {{fontSize : '12px', margin : '0px 0px 1px 0px'}} onClick = {() => {timer_control('playtime','start')}}>타이머 시작</Button><br/>
                    <Button variant="outline-dark" size = 'sm' style = {{fontSize : '12px', margin : '0px 0px 1px 0px'}} onClick = {() => {timer_control('playtime','stop')}}>타이머 정지</Button><br/>
                    <Button variant="outline-dark" size = 'sm' style = {{fontSize : '12px', margin : '0px 0px 1px 0px'}} onClick = {() => {timer_control('playtime','+60')}}>1분 추가</Button><br/>
                    <Button variant="outline-dark" size = 'sm' style = {{fontSize : '12px', margin : '0px 0px 1px 0px'}} onClick = {() => {timer_control('playtime','-30')}}>30초 감소</Button>
                </div>
            </div>
