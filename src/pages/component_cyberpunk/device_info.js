...
const DeviceInfo = (props) => {
	...
	function show_device(place, place_info) {
		if (place !== undefined && place_info !== undefined) {
			...
			switch (place_info.manage_state) {
				case "mo":
					manage_color = "open";
					break;
				case "mu":
				...
				case "ml":
					...
					break;
				case "mbm":
					manage_color = "battery_max";
					break;
				case "msf":
					manage_color = "starter_finish";
					break;
				case "me":
					manage_color = "escape";
					break;
				case "mtm":
					manage_color = "takenchip_max";
					break;
				default:
					break;
			}
			...
			switch (place.device_type) {
				case "itembox":
					return (
						<Badge bg={online_color} text='dark'>
							<Badge bg={online_color} text='dark'>
								{online_state}
							</Badge>
							<Badge bg={device_name_color} text='dark'>
								<div className='device_name'>{place.device_name}</div>
							</Badge>
							<Badge bg={game_color} text='dark'>
								{place_info.game_state}
							</Badge>
							<br></br>
							<Badge bg={manage_color} text='dark'>
								{place_info.manage_state}
							</Badge>
							<Badge bg={online_color} text='dark'>
								장치 :
							</Badge>
							<Badge bg={device_color} text='dark'>
								{place_info.device_state}
							</Badge>
							<br></br>
							<span>🔋</span>
							<Badge bg={online_color} text='dark'>
								{place_info.battery_pack}
							</Badge>
							<span>🌟</span>
							<Badge bg={online_color} text='dark'>
								{place_info.exp_pack}
				...
				case "generator":
					return (
						<Badge bg={online_color} text='dark'>
							...
							<span>🔋</span>
							<Badge bg={online_color} text='dark'>
								{place_info.battery_pack}/{place_info.max_battery_pack}
							</Badge>
						</Badge>
					);
				case "escapemachine":
