...
const ThemeControl = () => {
	...
	const exerciseroom = () => {
		return (
			<div className='iotglove_theme_exerciseroom'>
				<Badge bg='theme_exerciseroom' text='dark'>
					<span className='theme_glove_font'> 훈련소 </span>
					<br></br>
					...
					<Button
						variant='secondary'
						size='sm'
						onClick={exerciseroomhandleShow}
					>
						선택 확정
					</Button>
					<Modal show={chooseexerciseroom} onHide={exerciseroomhandleClose}>
						...
						<Modal.Footer>
							...
							<Button
								variant='primary'
								onClick={() => theme_confirm("exerciseroom", exercisegroup)}
							>
								선택 확정
							</Button>
						</Modal.Footer>
	...
	const cyberpunk = () => {
		return (
			<div className='iotglove_theme_cyberpunk'>
				<Badge bg='theme_cyberpunk' text='dark'>
					<span
						className='theme_glove_font'
					...
					<br></br>
					<Button variant='secondary' size='sm' onClick={cyberpunkhandleShow}>
						선택 확정
					</Button>
					<Modal show={choosecyberpunk} onHide={cyberpunkhandleClose}>
						...
						<Modal.Footer>
							...
							<Button
								variant='primary'
								onClick={() => theme_confirm("cyberpunk", cyberpunkgroup)}
							>
								선택 확정
							</Button>
						</Modal.Footer>
		...
		return (
			<div className={iotglove_theme}>
				<Badge bg={theme_color} text='dark'>
					...
					<Button variant='secondary' size='sm' onClick={() => photo(group)}>
						사진촬영
					</Button>
					{reset(group)}
					<Button
						variant='light'
						size='sm'
						onClick={() => stateChange(group, "setting")}
					>
						S
					</Button>
					<Button
						variant='danger'
						size='sm'
						onClick={() => stateChange(group, "ready")}
					>
						R
					</Button>
					<Button
						variant='warning'
						size='sm'
						onClick={() => stateChange(group, "activate")}
					>
						A
					</Button>
					<br></br>
					<Button
						variant='device_purple'
						size='sm'
						onClick={() => stateChange(group, "blink")}
					>
						술래 결정
					</Button>
					<br></br>
					...
					<form>
						<input
							type='checkbox'
							name='chosen_iot_glove'
							value={glove[0]}
							onChange={iotChosenAll}
							checked={
								iotinputcheck.includes("G" + glove[0][1] + "P1") &&
								iotinputcheck.includes("G" + glove[0][1] + "P2") &&
								iotinputcheck.includes("G" + glove[0][1] + "P3") &&
								iotinputcheck.includes("G" + glove[0][1] + "P4") &&
								iotinputcheck.includes("G" + glove[0][1] + "P5") &&
								iotinputcheck.includes("G" + glove[0][1] + "P6") &&
								iotinputcheck.includes("G" + glove[0][1] + "P7") &&
								iotinputcheck.includes("G" + glove[0][1] + "P8")
									? true
									: false
							}
						/>
						...
						<input
							...
							value={glove[0]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[0]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[0]}</label>
						<input
							type={iotinputcheck.includes(glove[0]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[0]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[0]) ? true : false}
						/>
						...
						<input
							...
							value={glove[1]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[1]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[1]}</label>
						<input
							type={iotinputcheck.includes(glove[1]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[1]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[1]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[2]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[2]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[2]}</label>
						<input
							type={iotinputcheck.includes(glove[2]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[2]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[2]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[3]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[3]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[3]}</label>
						<input
							type={iotinputcheck.includes(glove[3]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[3]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[3]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[4]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[4]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[4]}</label>
						<input
							type={iotinputcheck.includes(glove[4]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[4]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[4]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[5]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[5]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[5]}</label>
						<input
							type={iotinputcheck.includes(glove[5]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[5]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[5]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[6]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[6]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[6]}</label>
						<input
							type={iotinputcheck.includes(glove[6]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[6]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[6]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
						<input
							...
							value={glove[7]}
							onChange={iotChosen}
							checked={iotinputcheck.includes(glove[7]) ? true : false}
						/>
						<label className='checkbox_glove_font'>{glove[7]}</label>
						<input
							type={iotinputcheck.includes(glove[7]) ? "checkbox" : "hidden"}
							name='chosen_iot_glove'
							value={glove[7]}
							onChange={taggerChosen}
							checked={taggercheck.includes(glove[7]) ? true : false}
						/>
						<label className='checkbox_glove_font'></label>
						<br></br>
					</form>
					...
					<p style={{ fontSize: "15px", margin: "10px 0px 5px 0px" }}>
						{" "}
						결정된 술래
					</p>
	...
	const reset = (group) => {
		switch (group) {
			case "G1":
				return (
					<div>
						<Button variant='danger' size='sm' onClick={G1handleShow}>
							초기화
						</Button>
						<br></br>
			...
			case "G2":
				return (
					<div>
						<Button variant='danger' size='sm' onClick={G2handleShow}>
							초기화
						</Button>
						<br></br>
			...
			case "G3":
				return (
					<div>
						<Button variant='danger' size='sm' onClick={G3handleShow}>
							초기화
						</Button>
						<br></br>
			...
			case "G4":
				return (
					<div>
						<Button variant='danger' size='sm' onClick={G4handleShow}>
							초기화
						</Button>
						<br></br>
