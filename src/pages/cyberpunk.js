	...
	render() {
		...
		function place_check(device, device_info) {
			...
			if (device.length !== 0 && device_info.length !== 0) {
				...
				return (
					<div className='device_device_wrapper'>
		...
		function control(device, device_except_iot) {
			switch (device) {
				case "itembox":
					return (
						<Badge bg='bdg'>
							<span>아이템박스[{device}]</span>
							<br />
							<Button
								variant='danger'
								size='reset'
								onClick={() => {
									device_except_iot("itembox", "reset");
								}}
							>
								device reset
							</Button>
				...
				case "revivalmachine":
					return (
						<Badge bg='bdg'>
							<span>부활장치[{device}]</span>
							<br />
							<Button
								variant='danger'
								size='reset'
								onClick={() => {
									device_except_iot("revivalmachine", "reset");
								}}
							>
								device reset
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("revivalmachine", "S");
								}}
							>
								S
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("revivalmachine", "R");
								}}
							>
								R
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("revivalmachine", "A");
								}}
							>
								A
							</Button>
				...
				case "tagmachine":
					return (
						<Badge bg='bdg'>
							<span>태그머신[{device}]</span>
							<br />
							<Button
								variant='danger'
								size='reset'
								onClick={() => {
									device_except_iot("tagmachine", "reset");
								}}
							>
								device reset
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("tagmachine", "S");
								}}
							>
								S
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("tagmachine", "R");
								}}
							>
								R
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("tagmachine", "A");
								}}
							>
								A
							</Button>
				...
				case "generator":
					return (
						<Badge bg='bdg'>
							<span>발전기[{device}]</span>
							<br />
							<Button
								variant='danger'
								size='reset'
								onClick={() => {
									device_except_iot("generator", "reset");
								}}
							>
								device reset
							</Button>
				...
				case "escapemachine":
					return (
						<Badge bg='bdg'>
							<span>탈출장치[{device}]</span>
							<br />
							<Button
								variant='danger'
								size='reset'
								onClick={() => {
									device_except_iot("escapemachine", "reset");
								}}
							>
								device reset
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("escapemachine", "S");
								}}
							>
								S
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("escapemachine", "R");
								}}
							>
								R
							</Button>
							<Button
								...
								size='SRA'
								onClick={() => {
									device_except_iot("escapemachine", "A");
								}}
							>
								A
							</Button>
					...
					return (
						<Badge bg='bdg'>
							...
							<Button
								...
								size='reset'
								onClick={() => {
									device_except_iot("temple", "reset");
								}}
							>
								device reset
							</Button>
				...
				<div className='wrapper'>
					...
					<div className='controler'>
						<div className='controler_wrapper'>
							<Control
								itembox_info={this.state.itembox_info}
								revivalmachine_info={this.state.revivalmachine_info}
								tagmachine_info={this.state.tagmachine_info}
								duct_info={this.state.duct_info}
								generator_info={this.state.generator_info}
								escapemachine_info={this.state.escapemachine_info}
								temple_info={this.state.temple_info}
							/>
						</div>
					</div>
					...
					<div className='revivalmachine'>
						<div className='device_wrapper'>
							...
							<div className='device_device'>
								{place_check(
									this.state.revivalmachine,
									this.state.revivalmachine_info
								)}
							</div>
						</div>
					</div>
					...
					<div className='escapemachine'>
						<div className='device_wrapper'>
							...
							<div className='device_device'>
								{place_check(
									this.state.escapemachine,
									this.state.escapemachine_info
								)}
							</div>
						</div>
					</div>
