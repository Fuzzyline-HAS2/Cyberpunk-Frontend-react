                ...
                <div className='wrapper'>
                    ...
                    <div className='iotglove'>
                        <div className='iotglove_wrapper'>
                            <div className='iotglove_control'>
                                컨트롤
                            </div>
                            ...
                            >
                                <Tab eventKey="group1" title="Group1">
                                    <Group group = {this.state.group1} group_info = {this.state.group1_info}/>
                                </Tab>
                            ...
                            <div className='iotglove_group2'>
                                ...
                                >
                                    <Tab eventKey="group2" title="Group2">
                                        <Group group = {this.state.group2} group_info = {this.state.group2_info}/>
                                    </Tab>
                                    <Tab eventKey="skill" title="Skill" >
                            ...
                            <div className='iotglove_group3'>
                                ...
                                >
                                    <Tab eventKey="group3" title="Group3">
                                        <Group group = {this.state.group3} group_info = {this.state.group3_info}/>
                                    </Tab>
                                    <Tab eventKey="skill" title="Skill" disabled>
                            ...
                            <div className='iotglove_group4'>
                                ...
                                >
                                    <Tab eventKey="group4" title="Group4">
                                        <Group group = {this.state.group4} group_info = {this.state.group4_info}/>
                                    </Tab>
                                    <Tab eventKey="skill" title="Skill" disabled>
